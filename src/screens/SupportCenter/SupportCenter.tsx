...
export const SupportCenter = (): JSX.Element => {
    return (
        <div className="bg-[#f6f6f6] overflow-hidden w-full min-w-[1920px] flex flex-col">
            ...
            <section className="flex flex-col items-start gap-[30px] w-full mt-[72px]">
                ...
                <div className="flex items-start gap-6 w-full">
                                            ...
                                            <div className="flex items-center gap-[13px]">
                                                ...
                                                <div className="flex flex-col flex-1 items-start gap-1">
                                                    <div className="flex items-end justify-between w-full">
                                                        <h3 className="flex items-center justify-center [font-family:'DM_Sans_18pt-SemiBold',Helvetica] font-semibold text-[#003d2b] text-base tracking-[0] leading-6">
                                                            {option.title}
                                                        </h3>
                                                        <Badge className="bg-[#0b3a7833] text-[#0b3a78] text-[10px] leading-[9.2px] rounded-[528.3px] px-[9.25px] py-[5.28px] h-auto [font-family:'DM_Sans_18pt-Medium',Helvetica] font-medium hover:bg-[#0b3a7833]">
                                                            {option.badge}
                                                        </Badge>
                                                    </div>
                                                    <p className="flex items-center justify-center w-full [font-family:'DM_Sans_18pt-Regular',Helvetica] font-normal text-[#808080] text-sm tracking-[0] leading-[normal]">
                                                        {option.description}
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <div className="flex flex-col items-start gap-5 w-full">
                                        <div className="flex items-center justify-between gap-4 w-full">
                                            <div className="flex flex-col flex-1 items-start gap-2.5">
                                                <label className="flex items-center justify-center [font-family:'DM_Sans_18pt-Medium',Helvetica] font-medium text-[#003d2b] text-base tracking-[0] leading-6">
                                                    Email Address
                                                </label>
                                                <Input
                                                    placeholder="Enter email"
                                                    className="h-[50px] bg-[#fcfcfc] rounded-[10px] border border-solid border-[#e4e4e4] px-5 py-[15px] [font-family:'DM_Sans_18pt-Regular',Helvetica] font-normal text-[#808080] text-base"
                                                />
                                            </div>
                                            ...
                                            <div className="flex flex-col flex-1 items-start gap-2.5">
                                                ...
                                                <Select>
                                                    <SelectTrigger className="h-[50px] bg-[#fcfcfc] rounded-[10px] border border-solid border-[#e4e4e4] px-5 py-[15px] [font-family:'DM_Sans_18pt-Regular',Helvetica] font-normal text-[#808080] text-base">
                                        ...
                                        <div className="flex flex-col items-start gap-2.5 w-full">
                                            ...
                                            <Textarea
                                                ...
                                                className="h-[120px] bg-[#fcfcfc] rounded-[10px] border border-solid border-[#e4e4e4] px-5 py-[15px] [font-family:'DM_Sans_18pt-Regular',Helvetica] font-normal text-[#808080] text-base resize-none"
                                            />
                                        </div>
                                    </div>
                                </div>

                                <Button className="w-full h-[50px] rounded-lg bg-[linear-gradient(128deg,rgba(39,174,96,1)_0%,rgba(0,82,204,1)_100%)] [font-family:'DM_Sans_18pt-SemiBold',Helvetica] font-semibold text-white text-sm text-center tracking-[-0.20px] leading-[18px] hover:opacity-90">
                                    Create Support Ticket
                                </Button>
                            </CardContent>
                        </Card>
                    ...
                    <aside className="flex flex-col w-[542px] items-start gap-[26px]">
                        <Card className="w-full bg-[#fcfcfc] rounded-[20px] border-[0.8px] border-solid border-[#e4e4e4]">
                            <CardContent className="flex flex-col items-start gap-[30px] p-6">
                                <div className="inline-flex items-center gap-2.5">
                                    <img
                                ...
                                <nav className="flex flex-col items-start gap-3.5 w-full">
                                    {quickActions.map((action, index) => (
                                        <button
                                            key={index}
                                            className="w-full h-16 bg-[#fcfcfc] rounded-[10px] border border-solid border-[#e4e4e4] hover:bg-[#f6f6f6] transition-colors"
                                        >
                        ...
                        <Card className="w-full bg-[#fcfcfc] rounded-[20px] border-[0.8px] border-solid border-[#e4e4e4]">
                            <CardContent className="flex flex-col items-start gap-[30px] p-6">
                                ...
                                <div className="flex flex-col items-start gap-2.5 p-6 bg-[#1f4dd824] rounded-xl w-full">
                                    <div className="inline-flex flex-col items-start gap-[5px]">
                                        <p className="flex items-center justify-center [font-family:'DM_Sans_18pt-Medium',Helvetica] font-medium text-[#1f4dd8] text-sm tracking-[0] leading-[normal]">
                                            All times in GMT
                                        </p>
                                        <p className="flex items-center justify-center [font-family:'DM_Sans_18pt-Regular',Helvetica] font-normal text-[#1f4dd8] text-[13px] tracking-[0] leading-[normal]">
                        ...
                        <Card className="w-full px-[31px] py-[27px] bg-[#d3203024] rounded-2xl border-0">
                            <CardContent className="flex flex-col items-start gap-2.5 p-0">
                                <div className="inline-flex items-start gap-2.5">
                                    <img
                                        ...
                                        src="/fi-272340.svg"
                                    />
                                    <h2 className="flex items-center justify-center [font-family:'DM_Sans_18pt-Bold',Helvetica] font-bold text-[#d32030] text-[22px] tracking-[-0.20px] leading-7 whitespace-nowrap">
                                        Emergency Contact
                                    </h2>
                                </div>
                                <p className="flex items-center justify-center [font-family:'DM_Sans_18pt-Regular',Helvetica] font-normal text-[#d32030] text-lg tracking-[-0.20px] leading-7">
